...
-четкое закрепление границ земельного участка межевыми знаками на местности, позволяющие визуально определить границы участка.<br/>";
      	...
      	break;
      	case 'oformlenie':
      	$text='Специалисты ООО "Проектстрой" готовы помочь Вам555 в получении земельного участка в аренду или собственность.
...
- юридические услуги
- использование материнского капитала для строительства или реконструкции жилья
- консультация по вопросу о самовольной постройке
- представительство в суде


Но снова отметим, что это лишь наиболее востребованные услуги. Сфера юриспруденции - гибкая динамичная среда, в которой каждый день появляются новые вопросы. Какое бы затруднение ни возникло у Вас, если решение существует, то мы можем его добиться.
';
      	break;
      	case 'konsult':
      	$text="Невозможно отразить на нескольких страницах весь накопленный нашими специалистами опыт. В практике нашей энергичной и деятельной команды были даже вопросы не связанные напрямую со строительной сферой.
